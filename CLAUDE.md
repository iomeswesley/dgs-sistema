...
- **Número da colega da equipe** (coexistence — número já ativo no WhatsApp Business App dela) ainda não foi conectado. Esse fluxo é diferente do de um número novo: precisa ser iniciado *no celular*, abrindo o link de onboarding (`https://business.facebook.com/messaging/whatsapp/onboard/?app_id=1681012396346095&config_id=935268162166199`) no aparelho que já tem o WhatsApp Business App com aquele número — não dá pra fazer de outro dispositivo.
...
Tudo abaixo já foi feito. Fica só como histórico de decisão — pra pendências reais em aberto, ver "Pendências abertas nesta sessão" no topo do arquivo.
...
4. ~~Chave do Resend~~ — decisão do usuário: manter sem Resend por enquanto. Relatório por e-mail e resumo diário caem no stub de log. **Além disso, decisão nova de 2026-08-15: remover essa feature do código de vez (não só desativar)** — ver pendência aberta.
...
7. ~~Cron/Plano Pro da Vercel~~ — fora de escopo, disparo manual mesmo.
